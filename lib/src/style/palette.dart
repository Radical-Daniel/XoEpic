...
class Palette {
  ...
  Color get backgroundMain => const Color(0xfff78536);
  Color get backgroundLevelSelection => const Color(0xff2b4450);
  Color get backgroundPlaySession => const Color(0xff2b4450);
  Color get background4 => const Color(0xFF2b4450);
